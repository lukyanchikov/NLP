...
(3) Review the responses returned by Flask. "1" corresponds to "positive" sentiment, "0" - to "negative". In the below example, the responses produced by the two models differ:
